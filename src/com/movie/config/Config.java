...
import com.movie.control.AutorizadorInterceptor;
...
public class Config implements WebMvcConfigurer {
	...
	public MultipartResolver multipartResolver() { 
		...
		multipartResolver.setMaxUploadSize(100 * 1024 * 1024); // 100 mb
		multipartResolver.setMaxUploadSizePerFile(10 * 1024 * 1024); // 10 mb
	...
	@Autowired
	AutorizadorInterceptor someService;

	@Override
	public void addInterceptors(InterceptorRegistry registry) {
	       registry.addInterceptor(someService);
	}
